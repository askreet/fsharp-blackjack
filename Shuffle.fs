...
let rec shuffle' r l1 l2 =
    ...
    if len = 0 then
        ...
        shuffle' (myrandom 0 (len - 1) r) (snd t) (List.append l2 (fst t))

// -- | Shuffle a list
let shuffle l =
    // Todo:
    let seed = System.Random().Next(0, 192073098)
    shuffle' (myrandom 0 ((List.length l) - 1) seed) l []
